...
- **多方块优先 + 单一用途**:全跨度 21 台新增多方块(切配工坊/烹饪工坊/温室/大型磨坊/隧道烤炉/
  畜牧工坊/发酵窖/熟成窖/禽类养殖场/中央厨房/大型灌装厂/分割产线/生物反应器/育种实验室/大型温室/
  水产养殖场/气调保鲜仓/固定化酶厂/HPP 处理舱/分子料理编译器/造粮机),每台只承载一类工艺用途,
  **零新增单方块机器**,其余复用 GTCEu 机型;
- **无新生物**:模组不注册任何新实体;新增动物源(鸭/鹅/鹌鹑/虾/蟹)的产品由养殖场多方块
  **虚空生成**(饲料进→产品出,镜像姊妹项目采矿厂/钻井语法);
- **手工层**:工作台刀具组 + 篝火/熔炉 + 陶罐(前期炊事道具),约 50 道无电手做菜基线;
  陶罐为纯前期道具,电力时代由烹饪工坊/发酵窖完全替代;
